...
const EARN_METHODS = [
  {
    ...
    description:
      "Work through your personalized Web3 learning path. Each module you finish earns 100 HH2 points.",
  ...
  },
  {
    ...
    description:
      "Participate in the HomieHouse Farcaster community. Cast, engage, and build reputation with fellow homies.",
    cta: "Open Feed",
    href: "/feed",
    soon: false,
  },
  {
    ...
    description:
      "Compose and share casts about Web3, crypto, and community. Quality content gets noticed.",
    cta: "Compose",
    href: "/compose",
    soon: false,
  },
  {
    ...
    points: "Coming soon",
    description:
      "Bring your friends into the HomieHouse ecosystem. Referral rewards are coming soon.",
    cta: null,
    href: null,
    soon: true,
  },
...
export default function Hh2Client() {
  ...
  const onChainBalance =
    hh2Raw && decimals ? Number(formatUnits(hh2Raw, decimals)) : 0;
  ...
  const handleClaim = async () => {
    ...
    if (!authHeaders) {
      setClaimResult({
        ok: false,
        error: "Not authenticated — connect your Farcaster account first.",
      });
      return;
    }
          ...
          {isConnected ? (
            ...
            >
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                >
                  {Number(onChainBalance).toLocaleString(undefined, {
              ...
              {userFid && (
                ...
                >
                  ...
                  >
                    <span
                      style={{ fontSize: 13, color: "var(--muted-on-dark)" }}
                    >
                      Earned (off-chain)
                    </span>
                    <span
              ...
              {claimable > 0 && isOnBase && (
                ...
                >
                  {claiming
                    ? "Sending…"
                    : `Claim ${claimable} HH2 to ${truncate(address ?? "")} →`}
                </button>
              )}
              {claimable > 0 && !isOnBase && (
                <p
                ...
                <div style={{ marginTop: 12 }}>
                  {claimResult.ok ? (
                    ...
                    >
                      ...
                      >
                        ✅ {claimResult.amount} HH2 sent to{" "}
                        {truncate(address ?? "")}!
                      </p>
                      <a
                    ...
                    >
                      <p style={{ fontSize: 13, color: "#f87171", margin: 0 }}>
                        ⚠️{" "}
                        {claimResult.error || "Claim failed — please try again"}
                      </p>
                    </div>
                  )}
                </div>
            ...
            >
              ...
              >
                Connect your EVM wallet to view your HH2 balance, claim earned
                rewards, and trade on Uniswap. Rainbow, MetaMask, Coinbase,
                Trust, and WalletConnect are all supported.
              </p>
              <div
                style={{
                  display: "flex",
              ...
              {userFid && (
                ...
                >
                  ...
                  {claimable > 0 && (
                    ...
                    >
                      {claimable} HH2 ready to claim — connect your wallet to
                      withdraw!
                    </p>
                  )}
                </div>
