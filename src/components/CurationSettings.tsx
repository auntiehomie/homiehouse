...
export default function CurationSettings({ onClose }: CurationSettingsProps) {
  ...
  const [preferenceType, setPreferenceType] =
    useState<CurationPreference["preference_type"]>("keyword");
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto p-6">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setPreferenceType(
                    e.target.value as CurationPreference["preference_type"],
                  )
                }
            ...
            <div>
              ...
              <select
                value={action}
                onChange={(e) =>
                  setAction(e.target.value as "include" | "exclude")
                }
                className="w-full p-2 border rounded dark:bg-zinc-800 dark:border-zinc-700"
              >
          ...
          <div className="mb-4">
            ...
            {preferenceType === "content_type" ? (
              ...
              <input
                type={
                  preferenceType === "min_likes" ||
                  preferenceType === "max_length"
                    ? "number"
                    : "text"
                }
                value={preferenceValue}
        ...
        <div>
          ...
          {loading ? (
            ...
            <p className="text-center py-8 text-gray-500">
              No curation preferences yet. Add some above to customize your
              feed!
            </p>
          ) : (
        ...
        <div className="mt-6 pt-6 border-t dark:border-zinc-700">
          ...
          <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
            <li>
              • <strong>Include</strong> preferences boost content matching your
              interests
            </li>
            <li>
              • <strong>Exclude</strong> preferences hide unwanted content
            </li>
