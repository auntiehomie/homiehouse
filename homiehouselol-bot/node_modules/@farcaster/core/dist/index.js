...
__export(src_exports, {
  ...
  KeyAddBody: () => KeyAddBody,
  KeyRemoveBody: () => KeyRemoveBody,
  ...
  SignersByFidRequest: () => SignersByFidRequest,
  SignersByFidResponse: () => SignersByFidResponse,
  SignersByFidResponse_RequesterFidNoncesEntry: () => SignersByFidResponse_RequesterFidNoncesEntry,
  ...
  isKeyAddData: () => isKeyAddData,
  isKeyAddMessage: () => isKeyAddMessage,
  isKeyRemoveData: () => isKeyRemoveData,
  isKeyRemoveMessage: () => isKeyRemoveMessage,
  isLendStorageData: () => isLendStorageData,
  isLendStorageMessage: () => isLendStorageMessage,
  ...
  signerSourceFromJSON: () => signerSourceFromJSON,
  signerSourceToJSON: () => signerSourceToJSON,
  ...
  validateLiveAtUrl: () => validateLiveAtUrl,
...
var MessageType = /* @__PURE__ */ ((MessageType2) => {
  ...
  MessageType2[MessageType2["KEY_ADD"] = 16] = "KEY_ADD";
  MessageType2[MessageType2["KEY_REMOVE"] = 17] = "KEY_REMOVE";
  return MessageType2;
})(MessageType || {});
...
var UserDataType = /* @__PURE__ */ ((UserDataType3) => {
  ...
  UserDataType3[UserDataType3["LIVE_AT"] = 14] = "LIVE_AT";
...
var MessageData = {
  ...
  fromJSON(object) {
    return {
      ...
      keyAddBody: isSet2(object.keyAddBody) ? KeyAddBody.fromJSON(object.keyAddBody) : void 0,
      keyRemoveBody: isSet2(object.keyRemoveBody) ? KeyRemoveBody.fromJSON(object.keyRemoveBody) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
    ...
    message.keyAddBody !== void 0 && (obj.keyAddBody = message.keyAddBody ? KeyAddBody.toJSON(message.keyAddBody) : void 0);
    message.keyRemoveBody !== void 0 && (obj.keyRemoveBody = message.keyRemoveBody ? KeyRemoveBody.toJSON(message.keyRemoveBody) : void 0);
    return obj;
  },
  create(base) {
  ...
  fromPartial(object) {
    ...
    message.keyAddBody = object.keyAddBody !== void 0 && object.keyAddBody !== null ? KeyAddBody.fromPartial(object.keyAddBody) : void 0;
    message.keyRemoveBody = object.keyRemoveBody !== void 0 && object.keyRemoveBody !== null ? KeyRemoveBody.fromPartial(object.keyRemoveBody) : void 0;
    return message;
  }
};
...
var KeyAddBody = {
  ...
  fromJSON(object) {
    return {
      key: isSet2(object.key) ? bytesFromBase642(object.key) : new Uint8Array(),
      keyType: isSet2(object.keyType) ? Number(object.keyType) : 0,
      custodySignature: isSet2(object.custodySignature) ? bytesFromBase642(object.custodySignature) : new Uint8Array(),
      deadline: isSet2(object.deadline) ? Number(object.deadline) : 0,
      nonce: isSet2(object.nonce) ? Number(object.nonce) : 0,
      metadata: isSet2(object.metadata) ? bytesFromBase642(object.metadata) : new Uint8Array(),
      metadataType: isSet2(object.metadataType) ? Number(object.metadataType) : 0,
      registrationTxHash: isSet2(object.registrationTxHash) ? bytesFromBase642(object.registrationTxHash) : new Uint8Array(),
      scopes: Array.isArray(object == null ? void 0 : object.scopes) ? object.scopes.map((e) => Number(e)) : [],
      ttl: isSet2(object.ttl) ? Number(object.ttl) : 0
    };
  },
  toJSON(message) {
    const obj = {};
    ...
    message.custodySignature !== void 0 && (obj.custodySignature = base64FromBytes2(
      message.custodySignature !== void 0 ? message.custodySignature : new Uint8Array()
    ));
    message.deadline !== void 0 && (obj.deadline = Math.round(message.deadline));
    message.nonce !== void 0 && (obj.nonce = Math.round(message.nonce));
    message.metadata !== void 0 && (obj.metadata = base64FromBytes2(message.metadata !== void 0 ? message.metadata : new Uint8Array()));
    message.metadataType !== void 0 && (obj.metadataType = Math.round(message.metadataType));
    message.registrationTxHash !== void 0 && (obj.registrationTxHash = base64FromBytes2(
      message.registrationTxHash !== void 0 ? message.registrationTxHash : new Uint8Array()
    ));
    if (message.scopes) {
    ...
    message.ttl !== void 0 && (obj.ttl = Math.round(message.ttl));
    return obj;
  },
  create(base) {
    return KeyAddBody.fromPartial(base != null ? base : {});
  },
  fromPartial(object) {
    ...
    message.custodySignature = (_c = object.custodySignature) != null ? _c : new Uint8Array();
    message.deadline = (_d = object.deadline) != null ? _d : 0;
    message.nonce = (_e = object.nonce) != null ? _e : 0;
    message.metadata = (_f = object.metadata) != null ? _f : new Uint8Array();
    message.metadataType = (_g = object.metadataType) != null ? _g : 0;
    message.registrationTxHash = (_h = object.registrationTxHash) != null ? _h : new Uint8Array();
    message.scopes = ((_i = object.scopes) == null ? void 0 : _i.map((e) => e)) || [];
    message.ttl = (_j = object.ttl) != null ? _j : 0;
    return message;
  }
};
function createBaseKeyRemoveBody() {
...
var KeyRemoveBody = {
  ...
  fromJSON(object) {
    return {
      key: isSet2(object.key) ? bytesFromBase642(object.key) : new Uint8Array(),
      signature: isSet2(object.signature) ? bytesFromBase642(object.signature) : new Uint8Array(),
      signatureType: isSet2(object.signatureType) ? Number(object.signatureType) : 0,
      deadline: isSet2(object.deadline) ? Number(object.deadline) : 0,
      nonce: isSet2(object.nonce) ? Number(object.nonce) : 0
    };
  },
  toJSON(message) {
    ...
    message.key !== void 0 && (obj.key = base64FromBytes2(message.key !== void 0 ? message.key : new Uint8Array()));
    message.signature !== void 0 && (obj.signature = base64FromBytes2(message.signature !== void 0 ? message.signature : new Uint8Array()));
    message.signatureType !== void 0 && (obj.signatureType = Math.round(message.signatureType));
    message.deadline !== void 0 && (obj.deadline = Math.round(message.deadline));
    message.nonce !== void 0 && (obj.nonce = Math.round(message.nonce));
    return obj;
  },
  create(base) {
    return KeyRemoveBody.fromPartial(base != null ? base : {});
  },
  fromPartial(object) {
    var _a, _b, _c, _d, _e;
    const message = createBaseKeyRemoveBody();
    ...
    message.signatureType = (_c = object.signatureType) != null ? _c : 0;
    message.deadline = (_d = object.deadline) != null ? _d : 0;
    message.nonce = (_e = object.nonce) != null ? _e : 0;
    return message;
  }
...
var SignerSource = /* @__PURE__ */ ((SignerSource2) => {
  SignerSource2[SignerSource2["NONE"] = 0] = "NONE";
  SignerSource2[SignerSource2["ONCHAIN"] = 1] = "ONCHAIN";
  SignerSource2[SignerSource2["OFFCHAIN"] = 2] = "OFFCHAIN";
  return SignerSource2;
})(SignerSource || {});
function signerSourceFromJSON(object) {
  switch (object) {
    case 0:
    ...
    case "SIGNER_SOURCE_OFFCHAIN":
      return 2 /* OFFCHAIN */;
    default:
      throw new tsProtoGlobalThis8.Error("Unrecognized enum value " + object + " for enum SignerSource");
  }
}
function signerSourceToJSON(object) {
  switch (object) {
    case 0 /* NONE */:
...
function createBaseBlocksRequest() {
  return { startBlockNumber: 0, stopBlockNumber: void 0 };
}
var BlocksRequest = {
  ...
  fromPartial(object) {
    var _a, _b;
    const message = createBaseBlocksRequest();
    message.startBlockNumber = (_a = object.startBlockNumber) != null ? _a : 0;
    message.stopBlockNumber = (_b = object.stopBlockNumber) != null ? _b : void 0;
    return message;
  }
};
...
var StorageUnitDetails = {
  ...
  fromJSON(object) {
    return {
      ...
      purchasedUnitSize: isSet8(object.purchasedUnitSize) ? Number(object.purchasedUnitSize) : 0,
      lentUnitSize: isSet8(object.lentUnitSize) ? Number(object.lentUnitSize) : 0,
      borrowedUnitSize: isSet8(object.borrowedUnitSize) ? Number(object.borrowedUnitSize) : 0
    };
  },
  toJSON(message) {
    const obj = {};
    ...
    message.purchasedUnitSize !== void 0 && (obj.purchasedUnitSize = Math.round(message.purchasedUnitSize));
    message.lentUnitSize !== void 0 && (obj.lentUnitSize = Math.round(message.lentUnitSize));
    message.borrowedUnitSize !== void 0 && (obj.borrowedUnitSize = Math.round(message.borrowedUnitSize));
    return obj;
  },
  create(base) {
  ...
  fromPartial(object) {
    ...
    message.purchasedUnitSize = (_c = object.purchasedUnitSize) != null ? _c : 0;
    message.lentUnitSize = (_d = object.lentUnitSize) != null ? _d : 0;
    message.borrowedUnitSize = (_e = object.borrowedUnitSize) != null ? _e : 0;
    return message;
  }
};
...
var Signer = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          message.addedAt = longToNumber7(reader.uint64());
          continue;
        case 6:
          if (tag != 48) {
            break;
          }
          message.lastUsedAt = longToNumber7(reader.uint64());
          continue;
        case 7:
          if (tag != 56) {
            break;
        ...
        case 10:
          ...
          message.requestFid = longToNumber7(reader.uint64());
          continue;
        case 11:
          if (tag != 88) {
            break;
  ...
  fromJSON(object) {
    return {
      source: isSet8(object.source) ? signerSourceFromJSON(object.source) : 0,
      key: isSet8(object.key) ? bytesFromBase647(object.key) : new Uint8Array(),
      keyType: isSet8(object.keyType) ? Number(object.keyType) : 0,
      fid: isSet8(object.fid) ? Number(object.fid) : 0,
      addedAt: isSet8(object.addedAt) ? Number(object.addedAt) : void 0,
      lastUsedAt: isSet8(object.lastUsedAt) ? Number(object.lastUsedAt) : void 0,
      ttl: isSet8(object.ttl) ? Number(object.ttl) : void 0,
      expiresAt: isSet8(object.expiresAt) ? Number(object.expiresAt) : void 0,
      scopes: Array.isArray(object == null ? void 0 : object.scopes) ? object.scopes.map((e) => Number(e)) : [],
      requestFid: isSet8(object.requestFid) ? Number(object.requestFid) : void 0,
      nonce: isSet8(object.nonce) ? Number(object.nonce) : void 0,
      onchainEvent: isSet8(object.onchainEvent) ? OnChainEvent.fromJSON(object.onchainEvent) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
    message.source !== void 0 && (obj.source = signerSourceToJSON(message.source));
    message.key !== void 0 && (obj.key = base64FromBytes7(message.key !== void 0 ? message.key : new Uint8Array()));
    message.keyType !== void 0 && (obj.keyType = Math.round(message.keyType));
    message.fid !== void 0 && (obj.fid = Math.round(message.fid));
    message.addedAt !== void 0 && (obj.addedAt = Math.round(message.addedAt));
    message.lastUsedAt !== void 0 && (obj.lastUsedAt = Math.round(message.lastUsedAt));
    message.ttl !== void 0 && (obj.ttl = Math.round(message.ttl));
    message.expiresAt !== void 0 && (obj.expiresAt = Math.round(message.expiresAt));
    if (message.scopes) {
      obj.scopes = message.scopes.map((e) => Math.round(e));
    ...
    message.requestFid !== void 0 && (obj.requestFid = Math.round(message.requestFid));
    message.nonce !== void 0 && (obj.nonce = Math.round(message.nonce));
    message.onchainEvent !== void 0 && (obj.onchainEvent = message.onchainEvent ? OnChainEvent.toJSON(message.onchainEvent) : void 0);
    return obj;
  },
  create(base) {
    return Signer.fromPartial(base != null ? base : {});
  },
  fromPartial(object) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k;
    const message = createBaseSigner();
    message.source = (_a = object.source) != null ? _a : 0;
    message.key = (_b = object.key) != null ? _b : new Uint8Array();
    message.keyType = (_c = object.keyType) != null ? _c : 0;
    message.fid = (_d = object.fid) != null ? _d : 0;
    message.addedAt = (_e = object.addedAt) != null ? _e : void 0;
    message.lastUsedAt = (_f = object.lastUsedAt) != null ? _f : void 0;
    message.ttl = (_g = object.ttl) != null ? _g : void 0;
    message.expiresAt = (_h = object.expiresAt) != null ? _h : void 0;
    message.scopes = ((_i = object.scopes) == null ? void 0 : _i.map((e) => e)) || [];
    message.requestFid = (_j = object.requestFid) != null ? _j : void 0;
    message.nonce = (_k = object.nonce) != null ? _k : void 0;
    message.onchainEvent = object.onchainEvent !== void 0 && object.onchainEvent !== null ? OnChainEvent.fromPartial(object.onchainEvent) : void 0;
    return message;
  }
};
function createBaseSignerResponse() {
  return { signer: void 0 };
}
var SignerResponse = {
  encode(message, writer = import_minimal8.default.Writer.create()) {
    if (message.signer !== void 0) {
  ...
  fromJSON(object) {
    return { signer: isSet8(object.signer) ? Signer.fromJSON(object.signer) : void 0 };
  },
  toJSON(message) {
    const obj = {};
    message.signer !== void 0 && (obj.signer = message.signer ? Signer.toJSON(message.signer) : void 0);
    return obj;
  },
  create(base) {
    return SignerResponse.fromPartial(base != null ? base : {});
  },
  fromPartial(object) {
    const message = createBaseSignerResponse();
    message.signer = object.signer !== void 0 && object.signer !== null ? Signer.fromPartial(object.signer) : void 0;
    return message;
  }
};
function createBaseSignersByFidRequest() {
  return { fid: 0, pageSize: void 0, pageToken: void 0, reverse: void 0, requesterFids: [] };
}
var SignersByFidRequest = {
  encode(message, writer = import_minimal8.default.Writer.create()) {
    if (message.fid !== 0) {
      writer.uint32(8).uint64(message.fid);
    }
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          if (tag == 40) {
            message.requesterFids.push(longToNumber7(reader.uint64()));
            continue;
          }
          if (tag == 42) {
            const end2 = reader.uint32() + reader.pos;
  ...
  fromJSON(object) {
    return {
      ...
      pageToken: isSet8(object.pageToken) ? bytesFromBase647(object.pageToken) : void 0,
      reverse: isSet8(object.reverse) ? Boolean(object.reverse) : void 0,
      requesterFids: Array.isArray(object == null ? void 0 : object.requesterFids) ? object.requesterFids.map((e) => Number(e)) : []
    };
  },
  toJSON(message) {
    const obj = {};
  ...
  create(base) {
    return SignersByFidRequest.fromPartial(base != null ? base : {});
  },
  fromPartial(object) {
    var _a, _b, _c, _d, _e;
    const message = createBaseSignersByFidRequest();
    ...
    message.pageToken = (_c = object.pageToken) != null ? _c : void 0;
    message.reverse = (_d = object.reverse) != null ? _d : void 0;
    message.requesterFids = ((_e = object.requesterFids) == null ? void 0 : _e.map((e) => e)) || [];
    return message;
  }
};
function createBaseSignersByFidResponse() {
  return {
    signers: [],
...
var SignersByFidResponse = {
  encode(message, writer = import_minimal8.default.Writer.create()) {
    ...
    Object.entries(message.requesterFidNonces).forEach(([key, value]) => {
      SignersByFidResponse_RequesterFidNoncesEntry.encode({ key, value }, writer.uint32(50).fork()).ldelim();
    });
    return writer;
  },
  decode(input, length) {
  ...
  fromJSON(object) {
    return {
      signers: Array.isArray(object == null ? void 0 : object.signers) ? object.signers.map((e) => Signer.fromJSON(e)) : [],
      nextPageToken: isSet8(object.nextPageToken) ? bytesFromBase647(object.nextPageToken) : void 0,
      gaslessSignerCount: isSet8(object.gaslessSignerCount) ? Number(object.gaslessSignerCount) : 0,
      gaslessSignerLimit: isSet8(object.gaslessSignerLimit) ? Number(object.gaslessSignerLimit) : 0,
      currentUserNonce: isSet8(object.currentUserNonce) ? Number(object.currentUserNonce) : 0,
      requesterFidNonces: isObject3(object.requesterFidNonces) ? Object.entries(object.requesterFidNonces).reduce((acc, [key, value]) => {
        acc[Number(key)] = Number(value);
        return acc;
      }, {}) : {}
    };
  ...
  toJSON(message) {
    const obj = {};
    if (message.signers) {
      obj.signers = message.signers.map((e) => e ? Signer.toJSON(e) : void 0);
    } else {
      obj.signers = [];
    }
    message.nextPageToken !== void 0 && (obj.nextPageToken = message.nextPageToken !== void 0 ? base64FromBytes7(message.nextPageToken) : void 0);
    message.gaslessSignerCount !== void 0 && (obj.gaslessSignerCount = Math.round(message.gaslessSignerCount));
    message.gaslessSignerLimit !== void 0 && (obj.gaslessSignerLimit = Math.round(message.gaslessSignerLimit));
    message.currentUserNonce !== void 0 && (obj.currentUserNonce = Math.round(message.currentUserNonce));
  ...
  create(base) {
    return SignersByFidResponse.fromPartial(base != null ? base : {});
  },
  fromPartial(object) {
    var _a, _b, _c, _d, _e, _f;
    const message = createBaseSignersByFidResponse();
    message.signers = ((_a = object.signers) == null ? void 0 : _a.map((e) => Signer.fromPartial(e))) || [];
    message.nextPageToken = (_b = object.nextPageToken) != null ? _b : void 0;
    message.gaslessSignerCount = (_c = object.gaslessSignerCount) != null ? _c : 0;
    message.gaslessSignerLimit = (_d = object.gaslessSignerLimit) != null ? _d : 0;
    message.currentUserNonce = (_e = object.currentUserNonce) != null ? _e : 0;
    message.requesterFidNonces = Object.entries((_f = object.requesterFidNonces) != null ? _f : {}).reduce(
      (acc, [key, value]) => {
        if (value !== void 0) {
          acc[Number(key)] = Number(value);
        }
...
function createBaseSignersByFidResponse_RequesterFidNoncesEntry() {
  return { key: 0, value: 0 };
}
var SignersByFidResponse_RequesterFidNoncesEntry = {
  encode(message, writer = import_minimal8.default.Writer.create()) {
    if (message.key !== 0) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.key = longToNumber7(reader.uint64());
          continue;
        case 2:
          if (tag != 16) {
            break;
  ...
  fromJSON(object) {
    return { key: isSet8(object.key) ? Number(object.key) : 0, value: isSet8(object.value) ? Number(object.value) : 0 };
  },
  toJSON(message) {
    const obj = {};
    message.key !== void 0 && (obj.key = Math.round(message.key));
  ...
  create(base) {
    return SignersByFidResponse_RequesterFidNoncesEntry.fromPartial(base != null ? base : {});
  },
  fromPartial(object) {
    var _a, _b;
    const message = createBaseSignersByFidResponse_RequesterFidNoncesEntry();
...
var isLendStorageData = (data) => {
  return data.type === 15 /* LEND_STORAGE */ && typeof data.lendStorageBody !== "undefined";
};
var isLendStorageMessage = (message) => {
  return message.signatureScheme === 1 /* ED25519 */ && typeof message.data !== "undefined" && isLendStorageData(message.data);
};
var isKeyAddData = (data) => {
  return data.type === 16 /* KEY_ADD */ && typeof data.keyAddBody !== "undefined";
};
var isKeyAddMessage = (message) => {
  return message.signatureScheme === 1 /* ED25519 */ && typeof message.data !== "undefined" && isKeyAddData(message.data);
};
var isKeyRemoveData = (data) => {
  return data.type === 17 /* KEY_REMOVE */ && typeof data.keyRemoveBody !== "undefined";
};
var isKeyRemoveMessage = (message) => {
  return message.signatureScheme === 1 /* ED25519 */ && typeof message.data !== "undefined" && isKeyRemoveData(message.data);
};
...
var validateLiveAtUrl = (url) => {
  if (typeof url !== "string") {
    return (0, import_neverthrow6.err)(new HubError("bad_request.validation_failure", "live_at must be a string"));
  }
  if (url === "") {
    return (0, import_neverthrow6.ok)(url);
  }
  const urlBytesResult = utf8StringToBytes(url);
  if (urlBytesResult.isErr()) {
    return (0, import_neverthrow6.err)(new HubError("bad_request.invalid_param", "live_at must be encodable as utf8"));
  }
  if (urlBytesResult.value.length > 256) {
    return (0, import_neverthrow6.err)(new HubError("bad_request.invalid_param", "live_at > 256 bytes"));
  }
  let parsedUrl;
  try {
    parsedUrl = new URL(url);
  } catch {
    return (0, import_neverthrow6.err)(new HubError("bad_request.validation_failure", "live_at is not a valid URL"));
  }
  if (parsedUrl.protocol !== "https:") {
    return (0, import_neverthrow6.err)(new HubError("bad_request.validation_failure", "live_at must use https"));
  }
  return (0, import_neverthrow6.ok)(url);
};
...
var validateUserDataAddBody = (body) => {
  ...
  switch (type) {
    ...
    case 14 /* LIVE_AT */:
      if (valueBytes.length > 256) {
        return (0, import_neverthrow6.err)(new HubError("bad_request.validation_failure", "live_at value > 256"));
      }
      break;
    case 6 /* USERNAME */: {
      if (value !== "") {
...
var LendStorageBodyFactory = Factory.define(() => {
  return LendStorageBody.create({
    ...
    numUnits: import_faker.faker.datatype.number({ min: 1, max: 10 }),
    unitType: 2 /* UNIT_TYPE_2025 */
  });
});
var LendStorageDataFactory = Factory.define(() => {
  return MessageDataFactory.build({
    lendStorageBody: LendStorageBodyFactory.build(),
    type: 15 /* LEND_STORAGE */
  });
});
var LendStorageMessageFactory = Factory.define(
  ({ onCreate, transientParams }) => {
    onCreate((message) => {
      return MessageFactory.create(message, { transient: transientParams });
    });
    return MessageFactory.build(
      { data: LendStorageDataFactory.build(), signatureScheme: 1 /* ED25519 */ },
      { transient: transientParams }
    );
  }
);
var KeyAddBodyFactory = Factory.define(() => {
  return KeyAddBody.create({
    key: Ed25519PublicKeyFactory.build(),
    keyType: 1,
    custodySignature: Eip712SignatureFactory.build(),
    deadline: import_faker.faker.datatype.number({ min: 1, max: 2 ** 31 - 1 }),
    nonce: import_faker.faker.datatype.number({ min: 1, max: 2 ** 31 - 1 }),
    metadata: BytesFactory.build({}, { transient: { length: 64 } }),
    metadataType: 1,
    scopes: [1 /* CAST_ADD */],
    ttl: import_faker.faker.datatype.number({ min: 1, max: 60 * 60 * 24 * 365 })
  });
});
...
var KeyAddMessageFactory = Factory.define(
  ({ onCreate, transientParams }) => {
    onCreate((message) => {
      return MessageFactory.create(message, { transient: transientParams });
    });
    return MessageFactory.build(
      { data: KeyAddDataFactory.build(), signatureScheme: 1 /* ED25519 */ },
      { transient: transientParams }
    );
  }
);
var KeyRemoveBodyFactory = Factory.define(() => {
  return KeyRemoveBody.create({
    key: Ed25519PublicKeyFactory.build(),
...
var KeyRemoveMessageFactory = Factory.define(
  ({ onCreate, transientParams }) => {
    onCreate((message) => {
      return MessageFactory.create(message, { transient: transientParams });
    });
    return MessageFactory.build(
      { data: KeyRemoveDataFactory.build(), signatureScheme: 1 /* ED25519 */ },
      { transient: transientParams }
    );
  }
);
