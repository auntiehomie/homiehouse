...
var KeyAddBody = {
  ...
  fromPartial(object) {
    ...
    message.scopes = ((_a = object.scopes) == null ? void 0 : _a.map((e) => e)) || [];
...
function signerSourceFromJSON(object) {
  switch (object) {
    ...
    case "SIGNER_SOURCE_OFFCHAIN":
      return 2 /* OFFCHAIN */;
    default:
      throw new tsProtoGlobalThis6.Error("Unrecognized enum value " + object + " for enum SignerSource");
  }
}
...
var StorageUnitDetails = {
  ...
  fromJSON(object) {
    return {
      ...
      purchasedUnitSize: isSet6(object.purchasedUnitSize) ? Number(object.purchasedUnitSize) : 0,
      lentUnitSize: isSet6(object.lentUnitSize) ? Number(object.lentUnitSize) : 0,
      borrowedUnitSize: isSet6(object.borrowedUnitSize) ? Number(object.borrowedUnitSize) : 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var Signer = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          message.addedAt = longToNumber6(reader.uint64());
          continue;
        case 6:
          if (tag != 48) {
            break;
          }
          message.lastUsedAt = longToNumber6(reader.uint64());
          continue;
        case 7:
          if (tag != 56) {
            break;
        ...
        case 10:
          ...
          message.requestFid = longToNumber6(reader.uint64());
          continue;
        case 11:
          if (tag != 88) {
            break;
  ...
  fromJSON(object) {
    return {
      source: isSet6(object.source) ? signerSourceFromJSON(object.source) : 0,
      key: isSet6(object.key) ? bytesFromBase646(object.key) : new Uint8Array(),
      keyType: isSet6(object.keyType) ? Number(object.keyType) : 0,
      fid: isSet6(object.fid) ? Number(object.fid) : 0,
      addedAt: isSet6(object.addedAt) ? Number(object.addedAt) : void 0,
      lastUsedAt: isSet6(object.lastUsedAt) ? Number(object.lastUsedAt) : void 0,
      ttl: isSet6(object.ttl) ? Number(object.ttl) : void 0,
      expiresAt: isSet6(object.expiresAt) ? Number(object.expiresAt) : void 0,
      scopes: Array.isArray(object == null ? void 0 : object.scopes) ? object.scopes.map((e) => Number(e)) : [],
      requestFid: isSet6(object.requestFid) ? Number(object.requestFid) : void 0,
      nonce: isSet6(object.nonce) ? Number(object.nonce) : void 0,
      onchainEvent: isSet6(object.onchainEvent) ? OnChainEvent.fromJSON(object.onchainEvent) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
  ...
  fromPartial(object) {
    ...
    message.lastUsedAt = object.lastUsedAt ?? void 0;
    message.ttl = object.ttl ?? void 0;
    message.expiresAt = object.expiresAt ?? void 0;
    message.scopes = ((_a = object.scopes) == null ? void 0 : _a.map((e) => e)) || [];
    message.requestFid = object.requestFid ?? void 0;
...
var SignerResponse = {
  ...
  fromJSON(object) {
    return { signer: isSet6(object.signer) ? Signer.fromJSON(object.signer) : void 0 };
  },
  toJSON(message) {
    const obj = {};
...
var SignersByFidRequest = {
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          if (tag == 40) {
            message.requesterFids.push(longToNumber6(reader.uint64()));
            continue;
          }
          if (tag == 42) {
            const end2 = reader.uint32() + reader.pos;
  ...
  fromPartial(object) {
    ...
    message.pageToken = object.pageToken ?? void 0;
    message.reverse = object.reverse ?? void 0;
    message.requesterFids = ((_a = object.requesterFids) == null ? void 0 : _a.map((e) => e)) || [];
    return message;
  }
};
...
var SignersByFidResponse = {
  ...
  fromJSON(object) {
    return {
      ...
      nextPageToken: isSet6(object.nextPageToken) ? bytesFromBase646(object.nextPageToken) : void 0,
      gaslessSignerCount: isSet6(object.gaslessSignerCount) ? Number(object.gaslessSignerCount) : 0,
      gaslessSignerLimit: isSet6(object.gaslessSignerLimit) ? Number(object.gaslessSignerLimit) : 0,
      currentUserNonce: isSet6(object.currentUserNonce) ? Number(object.currentUserNonce) : 0,
      requesterFidNonces: isObject2(object.requesterFidNonces) ? Object.entries(object.requesterFidNonces).reduce((acc, [key, value]) => {
        acc[Number(key)] = Number(value);
        return acc;
      }, {}) : {}
    };
  ...
  fromPartial(object) {
    ...
    message.requesterFidNonces = Object.entries(object.requesterFidNonces ?? {}).reduce(
      (acc, [key, value]) => {
        if (value !== void 0) {
          acc[Number(key)] = Number(value);
        }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.key = longToNumber6(reader.uint64());
          continue;
        case 2:
          if (tag != 16) {
            break;
...
var HubServiceService = {
  ...
  getSigner: {
    ...
    requestSerialize: (value) => Buffer.from(SignerRequest.encode(value).finish()),
    requestDeserialize: (value) => SignerRequest.decode(value),
    responseSerialize: (value) => Buffer.from(SignerResponse.encode(value).finish()),
    responseDeserialize: (value) => SignerResponse.decode(value)
  },
  getSignersByFid: {
    path: "/HubService/GetSignersByFid",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value) => Buffer.from(SignersByFidRequest.encode(value).finish()),
    requestDeserialize: (value) => SignersByFidRequest.decode(value),
    responseSerialize: (value) => Buffer.from(SignersByFidResponse.encode(value).finish()),
    responseDeserialize: (value) => SignersByFidResponse.decode(value)
  },
  getOnChainEvents: {
