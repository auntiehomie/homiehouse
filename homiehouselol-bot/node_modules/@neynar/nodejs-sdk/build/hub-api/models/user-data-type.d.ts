...
export declare const UserDataType: {
    readonly UserDataTypePfp: "USER_DATA_TYPE_PFP";
    readonly UserDataTypeDisplay: "USER_DATA_TYPE_DISPLAY";
    readonly UserDataTypeBio: "USER_DATA_TYPE_BIO";
    readonly UserDataTypeUrl: "USER_DATA_TYPE_URL";
    readonly UserDataTypeUsername: "USER_DATA_TYPE_USERNAME";
};
