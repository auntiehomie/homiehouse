...
const UserApiFp = function (configuration) {
    ...
    return {
         ...
         *
         */
        async fetchVerifications(fid, options) {
            var _a, _b, _c;
            const localVarAxiosArgs = await localVarAxiosParamCreator.fetchVerifications(fid, options);
            const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
            const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['UserApi.fetchVerifications']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Follow a user  (In order to follow a user `signer_uuid` must be approved)
         ...
         *
         */
        async getFreshAccountFID(xWalletId, xNeynarExperimental, options) {
            var _a, _b, _c;
         ...
         *
         */
        async registerAccount(xWalletId, registerUserReqBody, options) {
            var _a, _b, _c;
...
const UserApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         *
         */
        fetchVerifications(requestParameters, options) {
...
class UserApi extends base_1.BaseAPI {
     ...
     */
    fetchVerifications(requestParameters, options) {
        return (0, exports.UserApiFp)(this.configuration).fetchVerifications(requestParameters.fid, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Follow a user  (In order to follow a user `signer_uuid` must be approved)
     * @summary Follow user
     ...
     */
    getFreshAccountFID(requestParameters, options) {
        return (0, exports.UserApiFp)(this.configuration).getFreshAccountFID(requestParameters.xWalletId, requestParameters.xNeynarExperimental, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns the best friends of a user ranked by mutual affinity score based on interactions with each other.
     * @summary Best friends
     ...
     */
    registerAccount(requestParameters, options) {
        return (0, exports.UserApiFp)(this.configuration).registerAccount(requestParameters.xWalletId, requestParameters.registerUserReqBody, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Search for Usernames
     * @summary Search for Usernames
