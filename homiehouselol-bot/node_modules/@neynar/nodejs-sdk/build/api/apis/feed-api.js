...
const FeedApiAxiosParamCreator = function (configuration) {
    return {
         ...
         *
         */
        fetchFeedByTopic: async (slug, xNeynarExperimental, withRecasts, viewerFid, limit, cursor, options = {}) => {
            // verify required parameter 'slug' is not null or undefined
            (0, common_1.assertParamExists)('fetchFeedByTopic', 'slug', slug);
         ...
         *
         */
        fetchTrendingFeed: async (xNeynarExperimental, limit, cursor, viewerFid, timeWindow, channelId, parentUrl, provider, options = {}) => {
...
const FeedApiFp = function (configuration) {
    ...
    return {
         ...
         *
         */
        async fetchFeedByTopic(slug, xNeynarExperimental, withRecasts, viewerFid, limit, cursor, options) {
            var _a, _b, _c;
            ...
            const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
            const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['FeedApi.fetchFeedByTopic']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Fetch a personalized For You feed for a user
         ...
         *
         */
        async fetchTrendingFeed(xNeynarExperimental, limit, cursor, viewerFid, timeWindow, channelId, parentUrl, provider, options) {
            var _a, _b, _c;
...
const FeedApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         *
         */
        fetchFeedByTopic(requestParameters, options) {
...
class FeedApi extends base_1.BaseAPI {
     ...
     */
    fetchFeedByTopic(requestParameters, options) {
        return (0, exports.FeedApiFp)(this.configuration).fetchFeedByTopic(requestParameters.slug, requestParameters.xNeynarExperimental, requestParameters.withRecasts, requestParameters.viewerFid, requestParameters.limit, requestParameters.cursor, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Fetch a personalized For You feed for a user
     * @summary For you
