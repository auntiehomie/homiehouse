...
const StudioApiAxiosParamCreator = function (configuration) {
    return {
         ...
         *
         */
        recover: async (recoverRequest, options = {}) => {
            // verify required parameter 'recoverRequest' is not null or undefined
            (0, common_1.assertParamExists)('recover', 'recoverRequest', recoverRequest);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(recoverRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         *
         */
        reportStudioUsage: async (reportStudioUsageRequest, options = {}) => {
            // verify required parameter 'reportStudioUsageRequest' is not null or undefined
            (0, common_1.assertParamExists)('reportStudioUsage', 'reportStudioUsageRequest', reportStudioUsageRequest);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(reportStudioUsageRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         *
         */
        startApp: async (startAppRequest, options = {}) => {
            // verify required parameter 'startAppRequest' is not null or undefined
            (0, common_1.assertParamExists)('startApp', 'startAppRequest', startAppRequest);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(startAppRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         *
         */
        stopApp: async (startAppRequest, options = {}) => {
            // verify required parameter 'startAppRequest' is not null or undefined
            (0, common_1.assertParamExists)('stopApp', 'startAppRequest', startAppRequest);
         ...
         *
         */
        upsertSecrets: async (upsertSecretsRequest, options = {}) => {
            // verify required parameter 'upsertSecretsRequest' is not null or undefined
            (0, common_1.assertParamExists)('upsertSecrets', 'upsertSecretsRequest', upsertSecretsRequest);
            const localVarPath = `/v2/studio/deployment/secrets/`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(upsertSecretsRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
const StudioApiFp = function (configuration) {
    ...
    return {
         ...
         *
         */
        async build(buildRequest, options) {
            var _a, _b, _c;
         ...
         *
         */
        async deleteSecrets(deleteSecretsRequest, options) {
            var _a, _b, _c;
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteSecrets(deleteSecretsRequest, options);
            const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
            const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['StudioApi.deleteSecrets']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Publishes the generated miniapp to Vercel via GitHub. Creates a GitHub repository, pushes code, creates a Vercel project linked to GitHub, and triggers deployment. Requires API key authentication. Note: Studio CU is tracked based on LLM token usage, not per API call.
         ...
         *
         */
        async getAccountAssociation(deploymentId, namespace, name, options) {
            var _a, _b, _c;
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAccountAssociation(deploymentId, namespace, name, options);
            const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
            const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['StudioApi.getAccountAssociation']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Retrieves messages in a specific conversation with cursor-based pagination (newest first). Requires API key authentication. Note: Studio CU is tracked based on LLM token usage, not per API call.
         ...
         *
         */
        async recover(recoverRequest, options) {
            var _a, _b, _c;
            const localVarAxiosArgs = await localVarAxiosParamCreator.recover(recoverRequest, options);
            const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
            const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['StudioApi.recover']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Called by miniapp-generator instances to report Claude SDK usage. Idempotent — duplicate submissions (same idempotency_key) are accepted but not double-counted.
         ...
         *
         */
        async reportStudioUsage(reportStudioUsageRequest, options) {
            var _a, _b, _c;
            const localVarAxiosArgs = await localVarAxiosParamCreator.reportStudioUsage(reportStudioUsageRequest, options);
            const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
            const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['StudioApi.reportStudioUsage']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Starts the Next.js development server for the generated miniapp. Requires Studio admin authentication. Note: Studio CU is tracked based on LLM token usage, not per API call.
         ...
         *
         */
        async startApp(startAppRequest, options) {
            var _a, _b, _c;
            const localVarAxiosArgs = await localVarAxiosParamCreator.startApp(startAppRequest, options);
            const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
            const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['StudioApi.startApp']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Stops the Next.js development server for the generated miniapp. Requires Studio admin authentication. Note: Studio CU is tracked based on LLM token usage, not per API call.
         ...
         *
         */
        async stopApp(startAppRequest, options) {
            var _a, _b, _c;
         ...
         *
         */
        async upsertSecrets(upsertSecretsRequest, options) {
            var _a, _b, _c;
            const localVarAxiosArgs = await localVarAxiosParamCreator.upsertSecrets(upsertSecretsRequest, options);
            const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
            const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['StudioApi.upsertSecrets']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Retrieves the build logs for a Vercel deployment. Useful for debugging failed deployments. Requires Studio admin authentication. Note: Studio CU is tracked based on LLM token usage, not per API call.
...
const StudioApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         *
         */
        deleteSecrets(requestParameters, options) {
         ...
         *
         */
        getAccountAssociation(requestParameters = {}, options) {
         ...
         *
         */
        recover(requestParameters, options) {
         ...
         *
         */
        reportStudioUsage(requestParameters, options) {
         ...
         *
         */
        startApp(requestParameters, options) {
         ...
         *
         */
        upsertSecrets(requestParameters, options) {
...
class StudioApi extends base_1.BaseAPI {
     ...
     */
    recover(requestParameters, options) {
        return (0, exports.StudioApiFp)(this.configuration).recover(requestParameters.recoverRequest, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Called by miniapp-generator instances to report Claude SDK usage. Idempotent — duplicate submissions (same idempotency_key) are accepted but not double-counted.
     * @summary Report studio compute unit usage
     ...
     */
    reportStudioUsage(requestParameters, options) {
        return (0, exports.StudioApiFp)(this.configuration).reportStudioUsage(requestParameters.reportStudioUsageRequest, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Starts the Next.js development server for the generated miniapp. Requires Studio admin authentication. Note: Studio CU is tracked based on LLM token usage, not per API call.
     * @summary Start generated miniapp
