...
export declare const UserApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     *
     */
    fetchUsersByLocation: (latitude: number, longitude: number, xNeynarExperimental?: boolean, viewerFid?: number, limit?: number, cursor?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     *
     */
    fetchVerifications: (fid: number, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     *
     */
    getFreshAccountFID: (xWalletId: string, xNeynarExperimental?: boolean, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     *
     */
    registerAccount: (xWalletId: string, registerUserReqBody: RegisterUserReqBody, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const UserApiFp: (configuration?: Configuration) => {
     ...
     *
     */
    fetchUsersByLocation(latitude: number, longitude: number, xNeynarExperimental?: boolean, viewerFid?: number, limit?: number, cursor?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UsersResponse>>;
    /**
     * Fetch all Ethereum and Solana verified addresses for a Farcaster user. Use this endpoint to identify which wallets are associated with which Farcaster applications for the specified user.
     * @summary Fetch verifications
     * @param {number} fid FID of the user whose verifications to fetch
     ...
     *
     */
    fetchVerifications(fid: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FetchVerifications200Response>>;
    /**
     * Follow a user  (In order to follow a user `signer_uuid` must be approved)
     * @summary Follow user
     * @param {FollowReqBody} followReqBody
     ...
     *
     */
    getFreshAccountFID(xWalletId: string, xNeynarExperimental?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserFIDResponse>>;
    /**
     * Returns the best friends of a user ranked by mutual affinity score based on interactions with each other.
     * @summary Best friends
     * @param {number} fid The FID of the user
     ...
     *
     */
    registerAccount(xWalletId: string, registerUserReqBody: RegisterUserReqBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RegisterUserResponse>>;
    /**
     * Search for Usernames
     * @summary Search for Usernames
     * @param {string} q
...
export declare class UserApi extends BaseAPI implements UserApiInterface {
     ...
     *
     */
    fetchVerifications(requestParameters: UserApiFetchVerificationsRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<FetchVerifications200Response, any, {}>>;
    /**
     * Follow a user  (In order to follow a user `signer_uuid` must be approved)
     * @summary Follow user
     * @param {UserApiFollowUserRequest} requestParameters Request parameters.
