...
exports.SimulateNftMintNetworkEnum = exports.GetTokenMetadataNetworkEnum = exports.FetchUserBalanceNetworksEnum = exports.FetchTrendingFungiblesTimeWindowEnum = exports.FetchTrendingFungiblesNetworkEnum = exports.FetchRelevantFungibleOwnersNetworkEnum = exports.FetchFungibleTradesTimeWindowEnum = exports.FetchFungibleTradesNetworkEnum = exports.FetchBulkRelevantFungibleOwnersNetworkEnum = exports.DeployFungibleNetworkEnum = exports.DeployFungibleMetadataNsfwEnum = exports.DeployFungibleFactoryEnum = exports.OnchainApi = exports.OnchainApiFactory = exports.OnchainApiFp = exports.OnchainApiAxiosParamCreator = void 0;
...
const OnchainApiAxiosParamCreator = function (configuration) {
    return {
         ...
         *
         */
        batchGetTokenMetadata: async (networks, addresses, options = {}) => {
            // verify required parameter 'networks' is not null or undefined
            (0, common_1.assertParamExists)('batchGetTokenMetadata', 'networks', networks);
            // verify required parameter 'addresses' is not null or undefined
            (0, common_1.assertParamExists)('batchGetTokenMetadata', 'addresses', addresses);
         ...
         *
         */
        createX402Signature: async (xWalletId, xApiKey, createX402SignatureRequest, options = {}) => {
            // verify required parameter 'xWalletId' is not null or undefined
            (0, common_1.assertParamExists)('createX402Signature', 'xWalletId', xWalletId);
            // verify required parameter 'xApiKey' is not null or undefined
            (0, common_1.assertParamExists)('createX402Signature', 'xApiKey', xApiKey);
            // verify required parameter 'createX402SignatureRequest' is not null or undefined
            (0, common_1.assertParamExists)('createX402Signature', 'createX402SignatureRequest', createX402SignatureRequest);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(createX402SignatureRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         *
         */
        createX402Siwx: async (xWalletId, xApiKey, createX402SiwxRequest, options = {}) => {
            // verify required parameter 'xWalletId' is not null or undefined
            (0, common_1.assertParamExists)('createX402Siwx', 'xWalletId', xWalletId);
            // verify required parameter 'xApiKey' is not null or undefined
            (0, common_1.assertParamExists)('createX402Siwx', 'xApiKey', xApiKey);
            // verify required parameter 'createX402SiwxRequest' is not null or undefined
            (0, common_1.assertParamExists)('createX402Siwx', 'createX402SiwxRequest', createX402SiwxRequest);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(createX402SiwxRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         *
         */
        deployErc721: async (xWalletId, deployErc721Request, options = {}) => {
            // verify required parameter 'xWalletId' is not null or undefined
            (0, common_1.assertParamExists)('deployErc721', 'xWalletId', xWalletId);
            // verify required parameter 'deployErc721Request' is not null or undefined
            (0, common_1.assertParamExists)('deployErc721', 'deployErc721Request', deployErc721Request);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(deployErc721Request, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         *
         */
        deployFungible: async (name, owner, symbol, factory, metadataDescription, metadataDiscord, metadataMedia, metadataNsfw, metadataTelegram, metadataTwitter, metadataWebsiteLink, network, options = {}) => {
         ...
         *
         */
        fetchBulkRelevantFungibleOwners: async (contractAddresses, network, viewerFid, options = {}) => {
            // verify required parameter 'contractAddresses' is not null or undefined
            (0, common_1.assertParamExists)('fetchBulkRelevantFungibleOwners', 'contractAddresses', contractAddresses);
            // verify required parameter 'network' is not null or undefined
            (0, common_1.assertParamExists)('fetchBulkRelevantFungibleOwners', 'network', network);
         ...
         *
         */
        generateImage: async (xWalletId, generateImageRequest, options = {}) => {
            // verify required parameter 'xWalletId' is not null or undefined
            (0, common_1.assertParamExists)('generateImage', 'xWalletId', xWalletId);
            // verify required parameter 'generateImageRequest' is not null or undefined
            (0, common_1.assertParamExists)('generateImage', 'generateImageRequest', generateImageRequest);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(generateImageRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         *
         */
        getTokenMetadata: async (network, address, options = {}) => {
            // verify required parameter 'network' is not null or undefined
            (0, common_1.assertParamExists)('getTokenMetadata', 'network', network);
            // verify required parameter 'address' is not null or undefined
            (0, common_1.assertParamExists)('getTokenMetadata', 'address', address);
         ...
         *
         */
        getWalletBalances: async (networks, address, limit, cursor, options = {}) => {
            // verify required parameter 'networks' is not null or undefined
            (0, common_1.assertParamExists)('getWalletBalances', 'networks', networks);
            // verify required parameter 'address' is not null or undefined
            (0, common_1.assertParamExists)('getWalletBalances', 'address', address);
         ...
         *
         */
        uploadTokenMetadata: async (xWalletId, uploadTokenMetadataRequest, options = {}) => {
            // verify required parameter 'xWalletId' is not null or undefined
            (0, common_1.assertParamExists)('uploadTokenMetadata', 'xWalletId', xWalletId);
            // verify required parameter 'uploadTokenMetadataRequest' is not null or undefined
            (0, common_1.assertParamExists)('uploadTokenMetadata', 'uploadTokenMetadataRequest', uploadTokenMetadataRequest);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(uploadTokenMetadataRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
const OnchainApiFp = function (configuration) {
    ...
    return {
         ...
         *
         */
        async batchGetTokenMetadata(networks, addresses, options) {
            var _a, _b, _c;
            ...
            const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['OnchainApi.batchGetTokenMetadata']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
         ...
         *
         */
        async createX402Siwx(xWalletId, xApiKey, createX402SiwxRequest, options) {
            var _a, _b, _c;
            const localVarAxiosArgs = await localVarAxiosParamCreator.createX402Siwx(xWalletId, xApiKey, createX402SiwxRequest, options);
            const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
            const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['OnchainApi.createX402Siwx']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Deploy a new ERC-721A (series) NFT collection.
         ...
         *
         */
        async deployErc721(xWalletId, deployErc721Request, options) {
            var _a, _b, _c;
            const localVarAxiosArgs = await localVarAxiosParamCreator.deployErc721(xWalletId, deployErc721Request, options);
            const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
            const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['OnchainApi.deployErc721']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Creates a new token. This is an allowlisted API, reach out if you want access.
         ...
         *
         */
        async deployFungible(name, owner, symbol, factory, metadataDescription, metadataDiscord, metadataMedia, metadataNsfw, metadataTelegram, metadataTwitter, metadataWebsiteLink, network, options) {
            var _a, _b, _c;
         ...
         *
         */
        async fetchBulkRelevantFungibleOwners(contractAddresses, network, viewerFid, options) {
            var _a, _b, _c;
            ...
            const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
            const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['OnchainApi.fetchBulkRelevantFungibleOwners']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Get recent trades for a specific fungible within a timeframe. Returns trades ordered by timestamp (most recent first).
         ...
         *
         */
        async generateImage(xWalletId, generateImageRequest, options) {
            var _a, _b, _c;
            const localVarAxiosArgs = await localVarAxiosParamCreator.generateImage(xWalletId, generateImageRequest, options);
            const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
            const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['OnchainApi.generateImage']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Fetch metadata for a specific token including price, market data, and basic information. Data is fetched from onchain-indexer with fallback to third-party providers.
         ...
         *
         */
        async getTokenMetadata(network, address, options) {
            var _a, _b, _c;
            const localVarAxiosArgs = await localVarAxiosParamCreator.getTokenMetadata(network, address, options);
            const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
            const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['OnchainApi.getTokenMetadata']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Fetch all token balances for a wallet address across multiple networks. Results are paginated.
         ...
         *
         */
        async getWalletBalances(networks, address, limit, cursor, options) {
            var _a, _b, _c;
            const localVarAxiosArgs = await localVarAxiosParamCreator.getWalletBalances(networks, address, limit, cursor, options);
            const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
            const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['OnchainApi.getWalletBalances']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Mints an NFT to one or more recipients on a specified network and contract, using a configured server wallet. Contact us to set up your wallet configuration if you don\'t have one.
         ...
         *
         */
        async registerAccountOnchain(xWalletId, registerUserOnChainReqBody, options) {
            var _a, _b, _c;
         ...
         *
         */
        async uploadTokenMetadata(xWalletId, uploadTokenMetadataRequest, options) {
            var _a, _b, _c;
            const localVarAxiosArgs = await localVarAxiosParamCreator.uploadTokenMetadata(xWalletId, uploadTokenMetadataRequest, options);
            const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
            const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['OnchainApi.uploadTokenMetadata']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    };
};
...
const OnchainApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         *
         */
        batchGetTokenMetadata(requestParameters, options) {
         ...
         *
         */
        createX402Signature(requestParameters, options) {
         ...
         *
         */
        createX402Siwx(requestParameters, options) {
         ...
         *
         */
        deployErc721(requestParameters, options) {
         ...
         *
         */
        fetchBulkRelevantFungibleOwners(requestParameters, options) {
         ...
         *
         */
        fetchFungibleTrades(requestParameters, options) {
         ...
         *
         */
        fetchFungibles(requestParameters, options) {
         ...
         *
         */
        fetchTrendingFungibles(requestParameters, options) {
         ...
         *
         */
        generateImage(requestParameters, options) {
         ...
         *
         */
        getTokenMetadata(requestParameters, options) {
         ...
         *
         */
        getWalletBalances(requestParameters, options) {
         ...
         *
         */
        uploadTokenMetadata(requestParameters, options) {
...
class OnchainApi extends base_1.BaseAPI {
     ...
     */
    batchGetTokenMetadata(requestParameters, options) {
        return (0, exports.OnchainApiFp)(this.configuration).batchGetTokenMetadata(requestParameters.networks, requestParameters.addresses, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Create a signature for a given x402 resource using the specified wallet.
     * @summary Create x402 signature
     ...
     */
    createX402Signature(requestParameters, options) {
        return (0, exports.OnchainApiFp)(this.configuration).createX402Signature(requestParameters.xWalletId, requestParameters.xApiKey, requestParameters.createX402SignatureRequest, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Create a Sign-In-With-X payload for a wallet-backed x402 resource.
     * @summary Create x402 Sign-In-With-X payload
     ...
     */
    createX402Siwx(requestParameters, options) {
        return (0, exports.OnchainApiFp)(this.configuration).createX402Siwx(requestParameters.xWalletId, requestParameters.xApiKey, requestParameters.createX402SiwxRequest, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Deploy a new ERC-721A (series) NFT collection.
     * @summary Deploy ERC-721 collection
     ...
     */
    deployErc721(requestParameters, options) {
        return (0, exports.OnchainApiFp)(this.configuration).deployErc721(requestParameters.xWalletId, requestParameters.deployErc721Request, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Creates a new token. This is an allowlisted API, reach out if you want access.
     * @summary Deploy fungible
     ...
     */
    fetchBulkRelevantFungibleOwners(requestParameters, options) {
        return (0, exports.OnchainApiFp)(this.configuration).fetchBulkRelevantFungibleOwners(requestParameters.contractAddresses, requestParameters.network, requestParameters.viewerFid, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Get recent trades for a specific fungible within a timeframe. Returns trades ordered by timestamp (most recent first).
     * @summary Get fungible trades
     ...
     */
    fetchFungibleTrades(requestParameters, options) {
        return (0, exports.OnchainApiFp)(this.configuration).fetchFungibleTrades(requestParameters.network, requestParameters.address, requestParameters.timeWindow, requestParameters.minAmountUsd, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Fetch details for fungible assets identified by fungible identifiers.
     * @summary Fetch fungibles
     ...
     */
    fetchFungibles(requestParameters, options) {
        return (0, exports.OnchainApiFp)(this.configuration).fetchFungibles(requestParameters.fungibles, requestParameters.xNeynarExperimental, requestParameters.viewerFid, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Fetch a list of relevant owners for a on chain asset. If a viewer is provided, only relevant holders will be shown. This usually shows on a fungible asset page as \"X, Y, Z and N others you know own this asset\".
     * @summary Relevant owners
     ...
     */
    fetchTrendingFungibles(requestParameters, options) {
        return (0, exports.OnchainApiFp)(this.configuration).fetchTrendingFungibles(requestParameters.network, requestParameters.timeWindow, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Fetches the token balances of a user given their FID
     * @summary Token balance
     ...
     */
    generateImage(requestParameters, options) {
        return (0, exports.OnchainApiFp)(this.configuration).generateImage(requestParameters.xWalletId, requestParameters.generateImageRequest, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Fetch metadata for a specific token including price, market data, and basic information. Data is fetched from onchain-indexer with fallback to third-party providers.
     * @summary Get token metadata
     ...
     */
    getTokenMetadata(requestParameters, options) {
        return (0, exports.OnchainApiFp)(this.configuration).getTokenMetadata(requestParameters.network, requestParameters.address, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Fetch all token balances for a wallet address across multiple networks. Results are paginated.
     * @summary Get wallet token balances
     ...
     */
    getWalletBalances(requestParameters, options) {
        return (0, exports.OnchainApiFp)(this.configuration).getWalletBalances(requestParameters.networks, requestParameters.address, requestParameters.limit, requestParameters.cursor, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Mints an NFT to one or more recipients on a specified network and contract, using a configured server wallet. Contact us to set up your wallet configuration if you don\'t have one.
     * @summary Mint NFT(s)
     ...
     */
    registerAccountOnchain(requestParameters, options) {
        return (0, exports.OnchainApiFp)(this.configuration).registerAccountOnchain(requestParameters.xWalletId, requestParameters.registerUserOnChainReqBody, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Send fungibles in bulk to several farcaster users. A funded wallet is to required use this API. React out to us on the Neynar channel on farcaster to get your wallet address.
     * @summary Send fungibles
     ...
     */
    uploadTokenMetadata(requestParameters, options) {
        return (0, exports.OnchainApiFp)(this.configuration).uploadTokenMetadata(requestParameters.xWalletId, requestParameters.uploadTokenMetadataRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
 ...
 * @export
 */
exports.FetchBulkRelevantFungibleOwnersNetworkEnum = {
    Ethereum: 'ethereum',
    Optimism: 'optimism',
    Base: 'base',
    Arbitrum: 'arbitrum'
 ...
 * @export
 */
exports.FetchFungibleTradesNetworkEnum = {
    Base: 'base'
};
/**
 * @export
 */
exports.FetchFungibleTradesTimeWindowEnum = {
    _1h: '1h',
    _6h: '6h',
    _12h: '12h',
    _24h: '24h',
 ...
 * @export
 */
exports.FetchTrendingFungiblesNetworkEnum = {
    Base: 'base'
};
/**
 * @export
 */
exports.FetchTrendingFungiblesTimeWindowEnum = {
    _1h: '1h',
    _6h: '6h',
    _12h: '12h',
    _24h: '24h',
 ...
 * @export
 */
exports.GetTokenMetadataNetworkEnum = {
    Ethereum: 'ethereum',
    Optimism: 'optimism',
    Base: 'base',
    Arbitrum: 'arbitrum'
