...
export declare const AuthAddressApiFp: (configuration?: Configuration) => {
     ...
     *
     */
    lookupDeveloperManagedAuthAddress(address: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LookupDeveloperManagedAuthAddress200Response>>;
    /**
     * Allow apps to register an Ethereum addresses as authorized \"auth addresses\" for a user\'s Farcaster account, enabling seamless Sign-In With Farcaster (SIWF) across applications without repeated custody wallet authorizations.
     * @summary Register Signed Key
     * @param {RegisterAuthAddressDeveloperManagedSignedKeyReqBody} registerAuthAddressDeveloperManagedSignedKeyReqBody
     ...
     *
     */
    registerSignedKeyForDeveloperManagedAuthAddress(registerAuthAddressDeveloperManagedSignedKeyReqBody: RegisterAuthAddressDeveloperManagedSignedKeyReqBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LookupDeveloperManagedAuthAddress200Response>>;
};
/**
...
export declare class AuthAddressApi extends BaseAPI implements AuthAddressApiInterface {
     ...
     *
     */
    lookupDeveloperManagedAuthAddress(requestParameters: AuthAddressApiLookupDeveloperManagedAuthAddressRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<LookupDeveloperManagedAuthAddress200Response, any, {}>>;
    /**
     * Allow apps to register an Ethereum addresses as authorized \"auth addresses\" for a user\'s Farcaster account, enabling seamless Sign-In With Farcaster (SIWF) across applications without repeated custody wallet authorizations.
     * @summary Register Signed Key
     * @param {AuthAddressApiRegisterSignedKeyForDeveloperManagedAuthAddressRequest} requestParameters Request parameters.
     ...
     *
     */
    registerSignedKeyForDeveloperManagedAuthAddress(requestParameters: AuthAddressApiRegisterSignedKeyForDeveloperManagedAuthAddressRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<LookupDeveloperManagedAuthAddress200Response, any, {}>>;
}
