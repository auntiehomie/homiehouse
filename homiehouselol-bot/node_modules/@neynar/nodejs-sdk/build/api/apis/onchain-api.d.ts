...
export declare const OnchainApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     *
     */
    createX402Siwx: (xWalletId: string, xApiKey: string, createX402SiwxRequest: CreateX402SiwxRequest, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     *
     */
    fetchBulkRelevantFungibleOwners: (contractAddresses: string, network: FetchBulkRelevantFungibleOwnersNetworkEnum, viewerFid?: number, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     *
     */
    fetchFungibleTrades: (network: FetchFungibleTradesNetworkEnum, address: string, timeWindow?: FetchFungibleTradesTimeWindowEnum, minAmountUsd?: number, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     *
     */
    fetchFungibles: (fungibles: string, xNeynarExperimental?: boolean, viewerFid?: number, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     *
     */
    generateImage: (xWalletId: string, generateImageRequest: GenerateImageRequest, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     *
     */
    uploadTokenMetadata: (xWalletId: string, uploadTokenMetadataRequest: UploadTokenMetadataRequest, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const OnchainApiFp: (configuration?: Configuration) => {
     ...
     *
     */
    createX402Siwx(xWalletId: string, xApiKey: string, createX402SiwxRequest: CreateX402SiwxRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateX402Siwx200Response>>;
    /**
     * Deploy a new ERC-721A (series) NFT collection.
     * @summary Deploy ERC-721 collection
     * @param {string} xWalletId Wallet ID to use for transactions
     ...
     *
     */
    fetchBulkRelevantFungibleOwners(contractAddresses: string, network: FetchBulkRelevantFungibleOwnersNetworkEnum, viewerFid?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BulkRelevantFungibleOwnersResponse>>;
    /**
     * Get recent trades for a specific fungible within a timeframe. Returns trades ordered by timestamp (most recent first).
     * @summary Get fungible trades
     * @param {FetchFungibleTradesNetworkEnum} network
     ...
     *
     */
    fetchFungibleTrades(network: FetchFungibleTradesNetworkEnum, address: string, timeWindow?: FetchFungibleTradesTimeWindowEnum, minAmountUsd?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FetchFungibleTrades200Response>>;
    /**
     * Fetch details for fungible assets identified by fungible identifiers.
     * @summary Fetch fungibles
     * @param {string} fungibles Comma-separated fungible identifiers
     ...
     *
     */
    fetchFungibles(fungibles: string, xNeynarExperimental?: boolean, viewerFid?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FungiblesResponseSchema>>;
    /**
     * Fetch a list of relevant owners for a on chain asset. If a viewer is provided, only relevant holders will be shown. This usually shows on a fungible asset page as \"X, Y, Z and N others you know own this asset\".
     * @summary Relevant owners
     * @param {string} contractAddress Contract address of the fungible asset
     ...
     *
     */
    generateImage(xWalletId: string, generateImageRequest: GenerateImageRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GenerateImage200Response>>;
    /**
     * Fetch metadata for a specific token including price, market data, and basic information. Data is fetched from onchain-indexer with fallback to third-party providers.
     * @summary Get token metadata
     * @param {GetTokenMetadataNetworkEnum} network A blockchain network e.g. \&quot;ethereum\&quot;, \&quot;optimism\&quot;, \&quot;base\&quot;, \&quot;arbitrum\&quot;
     ...
     *
     */
    uploadTokenMetadata(xWalletId: string, uploadTokenMetadataRequest: UploadTokenMetadataRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UploadTokenMetadata200Response>>;
};
/**
...
export declare class OnchainApi extends BaseAPI implements OnchainApiInterface {
     ...
     *
     */
    batchGetTokenMetadata(requestParameters: OnchainApiBatchGetTokenMetadataRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<BatchGetTokenMetadata200Response, any, {}>>;
    /**
     * Create a signature for a given x402 resource using the specified wallet.
     * @summary Create x402 signature
     * @param {OnchainApiCreateX402SignatureRequest} requestParameters Request parameters.
     ...
     *
     */
    createX402Signature(requestParameters: OnchainApiCreateX402SignatureRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<CreateX402Signature200Response, any, {}>>;
    /**
     * Create a Sign-In-With-X payload for a wallet-backed x402 resource.
     * @summary Create x402 Sign-In-With-X payload
     * @param {OnchainApiCreateX402SiwxRequest} requestParameters Request parameters.
     ...
     *
     */
    createX402Siwx(requestParameters: OnchainApiCreateX402SiwxRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<CreateX402Siwx200Response, any, {}>>;
    /**
     * Deploy a new ERC-721A (series) NFT collection.
     * @summary Deploy ERC-721 collection
     * @param {OnchainApiDeployErc721Request} requestParameters Request parameters.
     ...
     *
     */
    deployErc721(requestParameters: OnchainApiDeployErc721Request, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<DeployErc721201Response, any, {}>>;
    /**
     * Creates a new token. This is an allowlisted API, reach out if you want access.
     * @summary Deploy fungible
     * @param {OnchainApiDeployFungibleRequest} requestParameters Request parameters.
     ...
     *
     */
    fetchBulkRelevantFungibleOwners(requestParameters: OnchainApiFetchBulkRelevantFungibleOwnersRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<BulkRelevantFungibleOwnersResponse, any, {}>>;
    /**
     * Get recent trades for a specific fungible within a timeframe. Returns trades ordered by timestamp (most recent first).
     * @summary Get fungible trades
     * @param {OnchainApiFetchFungibleTradesRequest} requestParameters Request parameters.
     ...
     *
     */
    fetchFungibleTrades(requestParameters: OnchainApiFetchFungibleTradesRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<FetchFungibleTrades200Response, any, {}>>;
    /**
     * Fetch details for fungible assets identified by fungible identifiers.
     * @summary Fetch fungibles
     * @param {OnchainApiFetchFungiblesRequest} requestParameters Request parameters.
     ...
     *
     */
    fetchFungibles(requestParameters: OnchainApiFetchFungiblesRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<FungiblesResponseSchema, any, {}>>;
    /**
     * Fetch a list of relevant owners for a on chain asset. If a viewer is provided, only relevant holders will be shown. This usually shows on a fungible asset page as \"X, Y, Z and N others you know own this asset\".
     * @summary Relevant owners
     * @param {OnchainApiFetchRelevantFungibleOwnersRequest} requestParameters Request parameters.
     ...
     *
     */
    fetchTrendingFungibles(requestParameters: OnchainApiFetchTrendingFungiblesRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<FetchTrendingFungibles200Response, any, {}>>;
    /**
     * Fetches the token balances of a user given their FID
     * @summary Token balance
     * @param {OnchainApiFetchUserBalanceRequest} requestParameters Request parameters.
     ...
     *
     */
    generateImage(requestParameters: OnchainApiGenerateImageRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<GenerateImage200Response, any, {}>>;
    /**
     * Fetch metadata for a specific token including price, market data, and basic information. Data is fetched from onchain-indexer with fallback to third-party providers.
     * @summary Get token metadata
     * @param {OnchainApiGetTokenMetadataRequest} requestParameters Request parameters.
     ...
     *
     */
    getTokenMetadata(requestParameters: OnchainApiGetTokenMetadataRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<GetTokenMetadata200Response, any, {}>>;
    /**
     * Fetch all token balances for a wallet address across multiple networks. Results are paginated.
     * @summary Get wallet token balances
     * @param {OnchainApiGetWalletBalancesRequest} requestParameters Request parameters.
     ...
     *
     */
    getWalletBalances(requestParameters: OnchainApiGetWalletBalancesRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<GetWalletBalances200Response, any, {}>>;
    /**
     * Mints an NFT to one or more recipients on a specified network and contract, using a configured server wallet. Contact us to set up your wallet configuration if you don\'t have one.
     * @summary Mint NFT(s)
     * @param {OnchainApiMintNftRequest} requestParameters Request parameters.
     ...
     *
     */
    uploadTokenMetadata(requestParameters: OnchainApiUploadTokenMetadataRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<UploadTokenMetadata200Response, any, {}>>;
}
/**
 * @export
 */
 ...
 * @export
 */
export declare const FetchBulkRelevantFungibleOwnersNetworkEnum: {
 ...
 * @export
 */
export declare const FetchFungibleTradesNetworkEnum: {
    readonly Base: "base";
};
 ...
 * @export
 */
export declare const FetchFungibleTradesTimeWindowEnum: {
    readonly _1h: "1h";
    readonly _6h: "6h";
    readonly _12h: "12h";
    readonly _24h: "24h";
 ...
 * @export
 */
export declare const FetchTrendingFungiblesNetworkEnum: {
    readonly Base: "base";
};
 ...
 * @export
 */
export declare const FetchTrendingFungiblesTimeWindowEnum: {
    readonly _1h: "1h";
    readonly _6h: "6h";
    readonly _12h: "12h";
    readonly _24h: "24h";
 ...
 * @export
 */
export declare const GetTokenMetadataNetworkEnum: {
    readonly Ethereum: "ethereum";
    readonly Optimism: "optimism";
    readonly Base: "base";
    readonly Arbitrum: "arbitrum";
