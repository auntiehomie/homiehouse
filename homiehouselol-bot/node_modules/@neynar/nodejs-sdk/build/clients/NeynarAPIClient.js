...
const client = new NeynarAPIClient(config);\n`);
     ...
     *
     */
    async batchGetTokenMetadata(params) {
        const adjustedParams = {};
        Object.assign(adjustedParams, params);
     ...
     *
     */
    async createX402Signature(params) {
        var _a, _b;
        const adjustedParams = {};
        Object.assign(adjustedParams, params);
     ...
     *
     */
    async fetchFungibleTrades(params) {
        const adjustedParams = {};
        Object.assign(adjustedParams, params);
     ...
     *
     */
    async fetchTrendingFungibles(params) {
        const adjustedParams = {};
        Object.assign(adjustedParams, params);
     ...
     *
     */
    async associateDeployment(params) {
        const adjustedParams = {};
        Object.assign(adjustedParams, params);
     ...
     *
     */
    async getAccountAssociation(params) {
        const adjustedParams = {};
        Object.assign(adjustedParams, params);
     ...
     *
     */
    async getDeploymentFile(params) {
        const adjustedParams = {};
        Object.assign(adjustedParams, params);
     ...
     *
     */
    async listDeploymentFiles(params) {
        const adjustedParams = {};
        Object.assign(adjustedParams, params);
     ...
     *
     */
    async promptDeploymentStream(params) {
        const adjustedParams = {};
        Object.assign(adjustedParams, params);
     ...
     *
     */
    async reportStudioUsage(params) {
        const adjustedParams = {};
        Object.assign(adjustedParams, params);
    ...
    async getFreshAccountFID() {
        ...
        const adjustedParams = {};
        adjustedParams['xWalletId'] = (_b = (_a = this.config.baseOptions) === null || _a === void 0 ? void 0 : _a.headers) === null || _b === void 0 ? void 0 : _b['x-wallet-id'];
        adjustedParams['xNeynarExperimental'] = (_d = (_c = this.config.baseOptions) === null || _c === void 0 ? void 0 : _c.headers) === null || _d === void 0 ? void 0 : _d['x-neynar-experimental'];
