...
export declare class NeynarAPIClient {
     ...
     *
     */
    batchGetTokenMetadata(params: {
        networks: string[];
        addresses: string[];
    }): Promise<BatchGetTokenMetadata200Response>;
    /**
     ...
     *
     */
    createX402Signature(params: {
        xApiKey: string;
        createX402SignatureRequest: CreateX402SignatureRequest;
    }): Promise<CreateX402Signature200Response>;
    /**
     ...
     *
     */
    createX402Siwx(params: {
        xApiKey: string;
        createX402SiwxRequest: CreateX402SiwxRequest;
    }): Promise<CreateX402Siwx200Response>;
    /**
    ...
    }): Promise<DeployErc721201Response>;
    /**
    ...
    getTokenMetadata(params: {
        networks: string[];
        addresses: string[];
    }): Promise<GetTokenMetadata200Response>;
    /**
    ...
    getWalletBalances(params: {
        ...
        limit?: number;
        cursor?: string;
    }): Promise<GetWalletBalances200Response>;
    /**
    ...
    }): Promise<UpsertSecrets200Response>;
    /**
    ...
    getDevStatus(params: {
        ...
        namespace?: string;
        name?: string;
    }): Promise<GetDevStatus200Response>;
    /**
    ...
    listSecrets(params: {
        deploymentId: string;
        key?: string;
    }): Promise<ListSecrets200Response>;
    /**
     ...
     *
     */
    reportStudioUsage(params: {
        reportStudioUsageRequest: ReportStudioUsageRequest;
    }): Promise<ReportStudioUsage200Response>;
    /**
